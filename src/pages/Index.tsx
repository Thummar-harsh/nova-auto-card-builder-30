    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border border-white/20 hover:shadow-3xl transition-all duration-500 hover:-translate-y-1">
          {/* Header Section */}
          <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-700 text-white p-8 text-center relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent animate-pulse"></div>
            <div className="relative z-10">
              {/* Enhanced Logo */}
              <div className="w-24 h-24 bg-white rounded-full mx-auto mb-4 flex items-center justify-center shadow-xl border-4 border-white/20 hover:scale-105 transition-transform duration-300">
                <span className="text-blue-700 font-bold text-2xl tracking-wide">NA</span>
                <Sparkles className="absolute -top-1 -right-1 w-4 h-4 text-yellow-400 animate-pulse" />
              </div>
              <h1 className="text-4xl font-bold mb-3 tracking-wide">Nova Auto</h1>
              <div className="w-12 h-0.5 bg-white/60 mx-auto mb-3"></div>
              <p className="text-blue-100 text-base font-medium mb-2 leading-relaxed">Strong and reliable parts by Nova Auto.</p>
              <div className="inline-block bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                <p className="text-blue-100 text-sm font-semibold uppercase tracking-wider">Earthmoving Parts</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 space-y-5">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold py-4 px-6 rounded-2xl transition-all duration-300 flex items-center justify-center gap-3 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 active:scale-95 group"
            >
            ...
            <div className="grid grid-cols-2 gap-4">
              <a
                ...
                className="bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white font-medium py-4 px-4 rounded-2xl transition-all duration-300 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 active:scale-95 group"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-medium py-4 px-4 rounded-2xl transition-all duration-300 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 active:scale-95 group"
              >
          ...
          <div className="px-6 pb-6 space-y-4">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-gray-700 font-semibold text-lg px-3">Contact Information</h3>
              <div className="h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent flex-1"></div>
            </div>
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-gray-50 to-gray-100 hover:from-gray-100 hover:to-gray-200 border border-gray-200 hover:border-gray-300 rounded-2xl p-5 transition-all duration-300 flex items-start gap-4 text-left group shadow-sm hover:shadow-md transform hover:-translate-y-0.5"
            >
              <div className="w-10 h-10 bg-red-100 rounded-full flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
                <MapPin className="text-red-600" size={20} />
              </div>
              <div className="flex-1">
                <p className="text-gray-800 font-semibold text-base mb-1">Tap to open location</p>
                <p className="text-gray-600 text-sm leading-relaxed">(Rapid Technomat), Shapar - Veraval, Rajkot, Gujarat</p>
              </div>
            </button>

            {/* Phone/WhatsApp - Enhanced Grid */}
            <div className="grid grid-cols-2 gap-4">
              <button
                onClick={handleCall}
              ...
              >
                ...
                <div className="text-left">
                  <p className="text-gray-800 font-semibold text-sm">Call</p>
            ...
            <button
              onClick={handleEmail}
              className="w-full bg-gradient-to-r from-blue-50 to-indigo-50 hover:from-blue-100 hover:to-indigo-100 border border-blue-200 hover:border-blue-300 rounded-2xl p-5 transition-all duration-300 flex items-center gap-4 group shadow-sm hover:shadow-md transform hover:-translate-y-0.5"
            >
          ...
          {/* Enhanced Footer */}
          <div className="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-5 text-center border-t border-gray-200">
            <div className="flex items-center justify-center gap-2 mb-2">
              <div className="w-2 h-2 bg-blue-500 rounded-full animate-pulse"></div>
              <p className="text-gray-600 text-sm font-medium">Trusted by professionals</p>
              <div className="w-2 h-2 bg-blue-500 rounded-full animate-pulse"></div>
            </div>
